    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
            case R.id.action_menu_01:
                Toast.makeText(this,"action menu_01", Toast. LENGTH_SHORT).show();
                break;
            case R.id.action_menu_02:
                Toast.makeText(this,"action menu_02", Toast. LENGTH_SHORT).show();
                break;
            case R.id.action_menu_03:
                Toast.makeText(this,"action menu_03", Toast. LENGTH_SHORT).show();
                break;
        }
