...
import java.util.ArrayList;
    ...
    public class NetworkTask extends AsyncTask<Integer, String, Object> {
        ...
        public NetworkTask(Context context, String mAddr) {
            ...
            this.mAddr = mAddr;
            this.peoples =new ArrayList<JsonPeople>();
        }
        ...
        private  void parser(String str) {
            ...
            try {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    Log.v("RRR","code :" + code + "name :" + name + "dept :" + dept + "phone :" + phone + "img : " + img);

                    JsonPeople people = new JsonPeople(code, name, dept, phone, img);
                    peoples.add(people);
                }
