...
public class MAQ_Bean {
	...
	public MAQ_Bean(int aqNum, String aqQuestion, String aqAnswer1, String aqAnswer2) {
		super();
		this.aqNum = aqNum;
	...
	public MAQ_Bean(int aqNum, String aqQuestion, String aqAnswer1, String aqAnswer2, String aqScore1,
			String aqScore2) {
		super();
		this.aqNum = aqNum;
		this.aqQuestion = aqQuestion;
	...
	//Method
	//---------------------------------------------------------------------
	// 우클릭 -> source -> generated getters and setters
	public int getAqNum() {
		return aqNum;
	}
