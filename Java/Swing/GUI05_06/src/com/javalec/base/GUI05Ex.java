...
public class GUI05Ex {
	...
	private void add1() {
		sum[0]= Integer.parseInt(tfResult.getText());
		tfResult.setText("");
	}

	private void sumEqual() {
		sum[1]= Integer.parseInt(tfResult.getText()); 
		tfResult.setText(Integer.toString(sum[0]+sum[1]));
		sum[1]=Integer.parseInt(tfResult.getText());
